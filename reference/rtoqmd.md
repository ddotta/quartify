...
#> ✔ Quarto markdown file created: /tmp/RtmpL55IiM/output.qmd
...
#> ✔ Quarto markdown file created: /tmp/RtmpL55IiM/output_with_metadata.qmd
#> Rendering Quarto document to HTML...
#> ! Quarto is not installed or not available in PATH
#> ℹ Install Quarto from <https://quarto.org/docs/get-started/>
...
#> ✔ Quarto markdown file created: /tmp/RtmpL55IiM/output_styled.qmd
#> Rendering Quarto document to HTML...
#> ! Quarto is not installed or not available in PATH
#> ℹ Install Quarto from <https://quarto.org/docs/get-started/>
...
#> ✔ Quarto markdown file created: /tmp/RtmpL55IiM/output_quality.qmd
#> Rendering Quarto document to HTML...
#> ! Quarto is not installed or not available in PATH
#> ℹ Install Quarto from <https://quarto.org/docs/get-started/>
# }
