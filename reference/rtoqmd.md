...
#> ✔ Quarto markdown file created: /tmp/Rtmpnjd3Ex/output.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/Rtmpnjd3Ex/output.html
...
#> ✔ Quarto markdown file created: /tmp/Rtmpnjd3Ex/output_with_metadata.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/Rtmpnjd3Ex/output_with_metadata.html
...
#> ✔ Quarto markdown file created: /tmp/Rtmpnjd3Ex/output_styled.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/Rtmpnjd3Ex/output_styled.html
...
#> ✔ Quarto markdown file created: /tmp/Rtmpnjd3Ex/output_quality.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/Rtmpnjd3Ex/output_quality.html
# }
```
