...
#> ✔ Quarto markdown file created: /tmp/RtmpSTLiY6/output.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/RtmpSTLiY6/output.html
...
#> ✔ Quarto markdown file created: /tmp/RtmpSTLiY6/output_with_metadata.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/RtmpSTLiY6/output_with_metadata.html
...
#> ✔ Quarto markdown file created: /tmp/RtmpSTLiY6/output_styled.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/RtmpSTLiY6/output_styled.html
...
#> ✔ Quarto markdown file created: /tmp/RtmpSTLiY6/output_quality.qmd
#> Rendering Quarto document to HTML...
#> ✔ HTML file created: /tmp/RtmpSTLiY6/output_quality.html
# }
```
