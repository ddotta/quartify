...
La façon la plus simple de convertir plusieurs fichiers est d'utiliser l'interface web :
...
- **Sélectionner un répertoire** contenant vos scripts R (nouvelle fonctionnalité !)
