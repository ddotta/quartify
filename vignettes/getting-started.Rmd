...
3. **Explanatory comments**: Become readable text
4. **Code blocks**: Separated by comments or sections
...
| **Explanatory Text** | `# Text` | Plain text paragraph | `# This filters the data` |
